...
func Init() {
	...
	router.HandleFunc("/api/v1/traces/{traceName}/instruction/active", CUActiveInsts)
	router.HandleFunc("/api/v1/traces/{traceName}/instruction/count/insttype", instCountByInstType)
	router.HandleFunc("/api/v1/traces/{traceName}/instruction/count/execunit", instCountByExecUnit)
